...
void GPIO_voidSetPinMode(port_index_t Copy_PortIndex, pin_index_t Copy_PinIndex,
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
     case GPIO_PORTD:
      MODIFY_REG(GPIOD_MODER,
                 GPIO_MODER_CLEAR_MASK << GPIO_MODER_PIN_BITS * Copy_PinIndex,
                 Copy_GPIOPinMode << GPIO_MODER_PIN_BITS * Copy_PinIndex);
      break;
    case GPIO_PORTE:
      MODIFY_REG(GPIOE_MODER,
                 GPIO_MODER_CLEAR_MASK << GPIO_MODER_PIN_BITS * Copy_PinIndex,
                 Copy_GPIOPinMode << GPIO_MODER_PIN_BITS * Copy_PinIndex);
      break;
    case GPIO_PORTH:
      MODIFY_REG(GPIOH_MODER,
                 GPIO_MODER_CLEAR_MASK << GPIO_MODER_PIN_BITS * Copy_PinIndex,
                 Copy_GPIOPinMode << GPIO_MODER_PIN_BITS * Copy_PinIndex);
      break;
    default:
...
void GPIO_voidSetPinOutputMode(port_index_t Copy_PortIndex,
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
    case GPIO_PORTD:
      MODIFY_REG(GPIOD_OTYPER, GPIO_OTYPER_CLEAR_MASK << Copy_PinIndex,
                 Copy_OutputPinMode << Copy_PinIndex);
      break;
    case GPIO_PORTE:
      MODIFY_REG(GPIOE_OTYPER, GPIO_OTYPER_CLEAR_MASK << Copy_PinIndex,
                 Copy_OutputPinMode << Copy_PinIndex);
      break;
    case GPIO_PORTH:
      MODIFY_REG(GPIOH_OTYPER, GPIO_OTYPER_CLEAR_MASK << Copy_PinIndex,
                 Copy_OutputPinMode << Copy_PinIndex);
      break;
    default:
      break;
...
void GPIO_voidSetPinAlternateFunction(port_index_t Copy_PortIndex, pin_index_t Copy_PinIndex, u8 Copy_u8AlternateFunction)
{
	switch (Copy_PortIndex) {
	    ...
	    case GPIO_PORTD:
             if(Copy_PinIndex < 8)
             {
            	 MODIFY_REG(GPIOD_AFRL, GPIO_AF_CLEAR_MASK << Copy_PinIndex * GPIO_AF_PIN_BITS,
					  Copy_u8AlternateFunction << Copy_PinIndex * GPIO_AF_PIN_BITS);
             }
             else
             {
            	 MODIFY_REG(GPIOD_AFRH, GPIO_AF_CLEAR_MASK << (Copy_PinIndex-8) * GPIO_AF_PIN_BITS,
            			 Copy_u8AlternateFunction << (Copy_PinIndex-8) * GPIO_AF_PIN_BITS);
             }
	      break;
	    case GPIO_PORTE:
	    	if(Copy_PinIndex < 8)
	    	{
	    		MODIFY_REG(GPIOE_AFRL, GPIO_AF_CLEAR_MASK << Copy_PinIndex * GPIO_AF_PIN_BITS,
	    				Copy_u8AlternateFunction << Copy_PinIndex * GPIO_AF_PIN_BITS);
	    	}
	    	else
	    	{
	    		MODIFY_REG(GPIOE_AFRH, GPIO_AF_CLEAR_MASK << (Copy_PinIndex-8) * GPIO_AF_PIN_BITS,
	    				Copy_u8AlternateFunction << (Copy_PinIndex-8) * GPIO_AF_PIN_BITS);
	    	}
	      break;
	    case GPIO_PORTH:
	    	if(Copy_PinIndex < 8)
	    	{
	    		MODIFY_REG(GPIOH_AFRL, GPIO_AF_CLEAR_MASK << Copy_PinIndex * GPIO_AF_PIN_BITS,
	    				Copy_u8AlternateFunction << Copy_PinIndex * GPIO_AF_PIN_BITS);
	    	}
	    	else
	    	{
	    		MODIFY_REG(GPIOH_AFRH, GPIO_AF_CLEAR_MASK << (Copy_PinIndex-8) * GPIO_AF_PIN_BITS,
	    				Copy_u8AlternateFunction << (Copy_PinIndex-8) * GPIO_AF_PIN_BITS);
	    	}
	      break;
	    default:
...
void GPIO_voidSetPinValue(port_index_t Copy_PortIndex,
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTD:
      if (Copy_GPIOLogic == GPIO_HIGH) {
        WRITE_REG(GPIOD_BSRR, GPIO_SET_BIT_POS << Copy_PinIndex);
      } else if (Copy_GPIOLogic == GPIO_LOW) {
        WRITE_REG(GPIOD_BSRR, GPIO_RESET_BIT_POS << Copy_PinIndex);
      } else { /* Nothing */
      }
      break;
    case GPIO_PORTE:
      if (Copy_GPIOLogic == GPIO_HIGH) {
        WRITE_REG(GPIOE_BSRR, GPIO_SET_BIT_POS << Copy_PinIndex);
      } else if (Copy_GPIOLogic == GPIO_LOW) {
        WRITE_REG(GPIOE_BSRR, GPIO_RESET_BIT_POS << Copy_PinIndex);
      } else { /* Nothing */
      }
      break;
    case GPIO_PORTH:
      if (Copy_GPIOLogic == GPIO_HIGH) {
        WRITE_REG(GPIOH_BSRR, GPIO_SET_BIT_POS << Copy_PinIndex);
      } else if (Copy_GPIOLogic == GPIO_LOW) {
        WRITE_REG(GPIOH_BSRR, GPIO_RESET_BIT_POS << Copy_PinIndex);
      } else { /* Nothing */
      }
      break;
    default:
...
void GPIO_voidSetPinPullUpDownResistor(port_index_t Copy_PortIndex,
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
    case GPIO_PORTD:
      MODIFY_REG(GPIOD_PUPDR,
                 GPIO_PUPDR_CLEAR_MASK << GPIO_PUPDR_PIN_BITS * Copy_PinIndex,
                 Copy_InputPinMode << GPIO_PUPDR_PIN_BITS * Copy_PinIndex);
      break;
    case GPIO_PORTE:
      MODIFY_REG(GPIOE_PUPDR,
                 GPIO_PUPDR_CLEAR_MASK << GPIO_PUPDR_PIN_BITS * Copy_PinIndex,
                 Copy_InputPinMode << GPIO_PUPDR_PIN_BITS * Copy_PinIndex);
      break;
    case GPIO_PORTH:
      MODIFY_REG(GPIOH_PUPDR,
                 GPIO_PUPDR_CLEAR_MASK << GPIO_PUPDR_PIN_BITS * Copy_PinIndex,
                 Copy_InputPinMode << GPIO_PUPDR_PIN_BITS * Copy_PinIndex);
      break;
    default:
...
u8 GPIO_u8GetPinValue(port_index_t Copy_PortIndex, pin_index_t Copy_PinIndex) {
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
    case GPIO_PORTD:
      Local_u8PinValue = GET_BIT(GPIOD_IDR, Copy_PinIndex);
      break;
    case GPIO_PORTE:
      Local_u8PinValue = GET_BIT(GPIOE_IDR, Copy_PinIndex);
      break;
    case GPIO_PORTH:
      Local_u8PinValue = GET_BIT(GPIOH_IDR, Copy_PinIndex);
      break;
    default:
      break;
  }
...
void GPIO_voidLockPin(port_index_t Copy_PortIndex, pin_index_t Copy_PinIndex) {
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
    case GPIO_PORTD:
      WRITE_REG(GPIOD_LCKR, GPIO_LCKK_MASK | (1 << Copy_PinIndex));
      WRITE_REG(GPIOD_LCKR, (1 << Copy_PinIndex));
      WRITE_REG(GPIOD_LCKR, GPIO_LCKK_MASK | (1 << Copy_PinIndex));
      Local_u32LCKRDummyRead = READ_REG(GPIOD_LCKR);
      break;
    case GPIO_PORTE:
      WRITE_REG(GPIOE_LCKR, GPIO_LCKK_MASK | (1 << Copy_PinIndex));
      WRITE_REG(GPIOE_LCKR, (1 << Copy_PinIndex));
      WRITE_REG(GPIOE_LCKR, GPIO_LCKK_MASK | (1 << Copy_PinIndex));
      Local_u32LCKRDummyRead = READ_REG(GPIOE_LCKR);
      break;
    case GPIO_PORTH:
      WRITE_REG(GPIOH_LCKR, GPIO_LCKK_MASK | (1 << Copy_PinIndex));
      WRITE_REG(GPIOH_LCKR, (1 << Copy_PinIndex));
      WRITE_REG(GPIOH_LCKR, GPIO_LCKK_MASK | (1 << Copy_PinIndex));
      Local_u32LCKRDummyRead = READ_REG(GPIOH_LCKR);
      break;
    default:
      break;
  }
...
void GPIO_voidSetPortMode(port_index_t Copy_PortIndex, u32 Copy_u32GPIOPortMode) {
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
    case GPIO_PORTD:
      WRITE_REG(GPIOD_MODER, Copy_u32GPIOPortMode);
      break;
    case GPIO_PORTE:
      WRITE_REG(GPIOE_MODER, Copy_u32GPIOPortMode);
      break;
    case GPIO_PORTH:
      WRITE_REG(GPIOH_MODER, Copy_u32GPIOPortMode);
      break;
    default:
      break;
  }
...
void GPIO_voidSetPortOutputMode(port_index_t Copy_PortIndex,
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
    case GPIO_PORTD:
      WRITE_REG(GPIOD_OTYPER, Copy_u32OutputPortMode);
      break;
    case GPIO_PORTE:
      WRITE_REG(GPIOE_OTYPER, Copy_u32OutputPortMode);
      break;
    case GPIO_PORTH:
      WRITE_REG(GPIOH_OTYPER, Copy_u32OutputPortMode);
      break;
    default:
      break;
  }
...
void GPIO_voidSetPortOutputSpeed(port_index_t Copy_PortIndex,
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
    case GPIO_PORTD:
      WRITE_REG(GPIOD_OSPEEDR, Copy_u32OutputPortSpeed);
      break;
    case GPIO_PORTE:
      WRITE_REG(GPIOE_OSPEEDR, Copy_u32OutputPortSpeed);
      break;
    case GPIO_PORTH:
      WRITE_REG(GPIOH_OSPEEDR, Copy_u32OutputPortSpeed);
      break;
    default:
      break;
  }
...
void GPIO_voidSetPortValue(port_index_t Copy_PortIndex,
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTD:
      if (Copy_GPIOLogic == GPIO_HIGH) {
        WRITE_REG(GPIOD_ODR, GPIO_ODR_HIGH);
      } else if (Copy_GPIOLogic == GPIO_LOW) {
        WRITE_REG(GPIOD_ODR, GPIO_ODR_LOW);
      } else { /* Nothing */
      }
      break;
    case GPIO_PORTE:
      if (Copy_GPIOLogic == GPIO_HIGH) {
        WRITE_REG(GPIOE_ODR, GPIO_ODR_HIGH);
      } else if (Copy_GPIOLogic == GPIO_LOW) {
        WRITE_REG(GPIOE_ODR, GPIO_ODR_LOW);
      } else { /* Nothing */
      }
      break;
    case GPIO_PORTH:
      if (Copy_GPIOLogic == GPIO_HIGH) {
        WRITE_REG(GPIOH_ODR, GPIO_ODR_HIGH);
      } else if (Copy_GPIOLogic == GPIO_LOW) {
        WRITE_REG(GPIOH_ODR, GPIO_ODR_LOW);
      } else { /* Nothing */
      }
      break;
    default:
...
void GPIO_voidSetPortPullUpDownResistor(port_index_t Copy_PortIndex,
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
    case GPIO_PORTD:
      WRITE_REG(GPIOD_PUPDR, Copy_u32InputPortMode);
      break;
    case GPIO_PORTE:
      WRITE_REG(GPIOE_PUPDR, Copy_u32InputPortMode);
      break;
    case GPIO_PORTH:
      WRITE_REG(GPIOH_PUPDR, Copy_u32InputPortMode);
      break;
    default:
      break;
  }
...
u32 GPIO_u32GetPortValue(port_index_t Copy_PortIndex) {
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
    case GPIO_PORTD:
      Local_u32PortValue = READ_REG(GPIOD_IDR);
      break;
    case GPIO_PORTE:
      Local_u32PortValue = READ_REG(GPIOE_IDR);
      break;
    case GPIO_PORTH:
      Local_u32PortValue = READ_REG(GPIOH_IDR);
      break;
    default:
      break;
  }
...
void GPIO_voidLockPort(port_index_t Copy_PortIndex) {
  ...
  switch (Copy_PortIndex) {
    ...
    case GPIO_PORTC:
      ...
      break;
    case GPIO_PORTD:
      WRITE_REG(GPIOD_LCKR, GPIO_LCKK_MASK | GPIO_PORT_LOCKED);
      WRITE_REG(GPIOD_LCKR, GPIO_PORT_LOCKED);
      WRITE_REG(GPIOD_LCKR, GPIO_LCKK_MASK | GPIO_PORT_LOCKED);
      Local_u32LCKRDummyRead = READ_REG(GPIOD_LCKR);
      break;
    case GPIO_PORTE:
      WRITE_REG(GPIOE_LCKR, GPIO_LCKK_MASK | GPIO_PORT_LOCKED);
      WRITE_REG(GPIOE_LCKR, GPIO_PORT_LOCKED);
      WRITE_REG(GPIOE_LCKR, GPIO_LCKK_MASK | GPIO_PORT_LOCKED);
      Local_u32LCKRDummyRead = READ_REG(GPIOE_LCKR);
      break;
    case GPIO_PORTH:
      WRITE_REG(GPIOH_LCKR, GPIO_LCKK_MASK | GPIO_PORT_LOCKED);
      WRITE_REG(GPIOH_LCKR, GPIO_PORT_LOCKED);
      WRITE_REG(GPIOH_LCKR, GPIO_LCKK_MASK | GPIO_PORT_LOCKED);
      Local_u32LCKRDummyRead = READ_REG(GPIOH_LCKR);
      break;
    default:
